...
class FavoritesScreen extends StatelessWidget {
    ...
    return BlocConsumer<ShopCubit, ShopStates>(
      ...
      builder: (context, state) {
        return ConditionalBuilder(
          condition:state is !ShopFavoritesGetDataLoadingState,
  ...
  Widget buildFavoritesItem(FavData model , context) => Padding(
                  ...
                  children: [
                    ...
                    Row(
                      children: [
                        ...
                        IconButton(
                          onPressed: () {
                            navigateTo(context, Payment(model.product.price));
                          },
                          icon:CircleAvatar(
